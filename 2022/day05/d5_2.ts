...
instructions.forEach((instruction) => {
	...
	console.log("colToMove", colToMove);
	const itemsToMove = colToMove.splice(
		colToMove.length - cratesToMove,
		cratesToMove
	);
	...
	//adding
	let colToAdd = crateMap.get(to);
	colToAdd = colToAdd.concat(itemsToMove);
